...
?>
        ...
        public function edit_insert_to_post_text( $safe_text, $text ) {
            ...
            } //is_admin() && 'Insert into Post' == $safe_text
            return $safe_text;
        }
      ...
      <br style="clear:both"><br>
            ...
            foreach ( $this->_fields as $field ) {
                ...
                } //method_exists( $this, 'show_field_' . $field[ 'type' ] )
                else {
                    switch ( $field[ 'type' ] ) {
                        case 'TABS':
                            echo '<div id="tabs">' . "\n";
        ...
        public function load_scripts_styles( ) {
            ...
            } //array( 'upload', 'color', 'date', 'time', 'code', 'select', 'editor', 'plupload' ) as $type
        ...
        public function check_field_code( ) {
            ...
            } //$this->has_field( 'code' ) && $this->is_edit_page()
        }
        ...
        public function check_field_editor( ) {
            if ( $this->has_Field( 'editor' ) ) {
                ...
                } //version_compare( $wp_version, '3.2.1' ) < 1
            } //$this->has_Field( 'editor' )
        }
        ...
        public function check_field_select( ) {
            ...
            } //$this->has_field_any( array( 'select', 'typo' ) ) && $this->is_edit_page()
        }
        ...
        public function check_field_plupload( ) {
            ...
            } //$this->has_field( 'plupload' ) && $this->is_edit_page()
        }
        ...
        public function wp_ajax_delete_image( ) {
            ...
            if ( $ok ) {
                ...
                echo json_encode( array(
                     'message' => __( 'Cannot delete file. Something\'s wrong.', 'apc' ) 
                ) );
                die( );
            }
        }
        ...
        public function check_field_color( ) {
            ...
            } //$this->has_field_any( array( 'color', 'typo' ) ) && $this->is_edit_page()
...
.at-repater-block{background-color: #FFFFFF;border: 1px solid;margin: 2px;}
        ...
        public function show_field_begin( $field, $meta ) {
            ...
            if ( $this->saved_flag && $this->errors_flag && isset( $field[ 'validate' ] ) && isset( $field[ 'id' ] ) && $this->has_error( $field[ 'id' ] ) ) {
                ...
                echo '</div>' . "\n";
            } //$this->saved_flag && $this->errors_flag && isset( $field[ 'validate' ] ) && isset( $field[ 'id' ] ) && $this->has_error( $field[ 'id' ] )
        ...
        public function show_field_cond( $field, $meta ) {
            ...
            if ( is_array( $meta ) && isset( $meta[ 'enabled' ] ) && $meta[ 'enabled' ] == 'on' ) {
                $checked = true;
            } //is_array( $meta ) && isset( $meta[ 'enabled' ] ) && $meta[ 'enabled' ] == 'on'
        ...
        public function show_field_media_manager( $field, $meta ) {
            ...
            } //is_array( $meta ) && isset( $meta[ 'src' ] ) && $meta[ 'src' ] != ''
            else {
        ...
        public function save( $repeater = false ) {
            ...
            foreach ( $this->_fields as $field ) {
                if ( !in_array( $field[ 'type' ], $skip ) ) {
                    ...
                    } //class_exists( $validationClass ) && isset( $field[ 'validate_func' ] ) && method_exists( $validationClass, $field[ 'validate_func' ] )
        ...
        public function save_field( $field, $old, $new ) {
            ...
            } //isset( $field[ 'multiple' ] ) && $field[ 'multiple' ] && $field[ 'type' ] != 'plupload'
            else {
        ...
        public function has_field( $type ) {
            ...
            foreach ( $this->_fields as $field ) {
                ...
                } //'repeater' == $field[ 'type' ] || 'cond' == $field[ 'type' ]
            } //$this->_fields as $field
    ...
    ';
        ...
        public function admin_redirect_download_files( ) {
            ...
            if ( array_key_exists( 'theme_export_options', $wp->query_vars ) && $wp->query_vars[ 'theme_export_options' ] == 'safe_download' && $this->option_group == $_REQUEST[ 'option_group' ] ) {
                $this->download_file();
                die( );
            } //array_key_exists( 'theme_export_options', $wp->query_vars ) && $wp->query_vars[ 'theme_export_options' ] == 'safe_download' && $this->option_group == $_REQUEST[ 'option_group' ]
        }
            ...
            foreach ( $field[ 'validate' ] as $type => $args ) {
                if ( method_exists( $this, 'is_' . $type ) ) {
                    if ( call_user_func( array(
                        ...
                        $ret = false;
                    } //call_user_func( array( $this, 'is_' . $type ), $meta, $args[ 'param' ] ) === false
                } //method_exists( $this, 'is_' . $type )
            } //$field[ 'validate' ] as $type => $args
            return $ret;
        }
        ...
        public function is_phone( $val ) {
            return (bool) preg_match( "/^\+(9[976]\d|8[987530]\d|6[987]\d|5[90]\d|42\d|3[875]\d|2[98654321]\d|9[8543210]|8[6421]|6[6543210]|5[87654321]|4[987654310]|3[9643210]|2[70]|7|1)\W*\d\W*\d\W*\d\W*\d\W*\d\W*\d\W*\d\W*\d\W*(\d{1,2})$/i", $val );
            //just international phone numbers
        }
